...
## スピーカー紹介
<img src="https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/122800/eceb4cf8-fa97-7228-f41d-80c59e8178ec.jpeg" height="320px">

- 中　翔（nomuraya）
- Qiita名: nomurasan
- エンジニア兼新卒講師

本日は講師側の目線で「エンジニア未経験文系がAI人材になるには？」という観点で本書をレビューしていきます。
...
## 話さないこと
- AIまたは機械学習、統計や数学などの基礎知識（こういうのが分かるなら文系になってない！という声が聞こえてきそう）
...
オモシロAIごった煮会の前段でChatGPT部（同じ主催の方）にて、「輪読会やりたい」という話になったので、せっかくだから一番槍を務めようと！（要出典）
...
- 一番最初に読むべきは5章「AI企画力を磨く」
  - 本書のメインコンテンツ。5章自体は2-4章を6章につなぐステップだが、本質が短いページ数に詰まっていて読みやすい 
- AIを作る時代から使う時代へ
...
- AI系は理系が強い。とはいえ、文系だからこそのバリューを出そう！
  - AIに限らず、理系←→文系で業務を補完してきた歴史がある。AIによって理系が強くなったわけではない
